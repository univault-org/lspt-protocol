...
enum class SRPTConnectionState {
    CLOSED,
    SYN_SENT,
    SYN_RECEIVED,
    ESTABLISHED,
...
public:
    ...
    // State management
    SRPTConnectionState getState() const;
    void setState(SRPTConnectionState newState);
...
private:
    ...
    bool isValidTransition(SRPTConnectionState newState) const;
};
