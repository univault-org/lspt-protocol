...
foreach(_cmake_expected_target IN ITEMS SRPT::srpt-protocol SRPT::nlohmann_json)
...
# Create imported target SRPT::srpt-protocol
add_library(SRPT::srpt-protocol STATIC IMPORTED)
...
add_library(SRPT::nlohmann_json INTERFACE IMPORTED)

set_target_properties(SRPT::nlohmann_json PROPERTIES
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/srpt-protocol-targets-*.cmake")
